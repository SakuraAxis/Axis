...
"""
    _rust_stub_name(jl_name::Symbol) -> Symbol

Return the private Julia stub name generated by `@rust_fn`.
Users should call these through `@call_rust_fn name(args...)`.
"""
function _rust_stub_name(jl_name::Symbol)::Symbol
    return Symbol("__axis_rust_", string(jl_name))
end
